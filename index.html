...
<head>
  ...
  <script id="angularScript" src="//ajax.googleapis.com/ajax/libs/angularjs/1.3.15/angular.min.js"></script>
...
<body  ng-controller="AppController">
  ...
  <div class="jumbotron" ng-cloak>
    <div class="jumbotron-header">
      <nav class="jumbotron-sections">
        <div class="ng-link-left">
          <a href="https://angularu.com/ng/" target="_blank">
            <div class="jumbotron-logo">
              <img src="./img/angular-u-logo.png">
            </div>
            <div class="data">
              <h2>Angular U</h2>
              <p class="date">June 22nd - 25th 2015</p>
              <p>San Francisco, California</p>
            </div>
          </a>
        </div>
        <div class="ng-link-right">
          <a href="http://www.ng-conf.org/" target="_blank">
            <div class="jumbotron-logo">
              <img src="./img/ng-conf-logo.png">
            </div>
            <div class="data">
              <h2>ng-conf</h2>
              <p class="date">March 5th-6th 2015</p>
  ...
  <script src="//code.angularjs.org/1.3.15/i18n/angular-locale_sk.js"></script>
  <script>
    angular.module('ngLocal.sk', [])._configBlocks.push(angular.module('ngLocale')._configBlocks[0]);
  </script>
  <script src="//code.angularjs.org/1.3.15/i18n/angular-locale_en-us.js"></script>
  <script>
